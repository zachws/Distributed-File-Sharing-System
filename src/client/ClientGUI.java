...
public class ClientGUI extends Application {
    ...
    /**
     * Shows the login page for the GUI, called when app starts
     */
    ...
    /**
     * Shows the main page which displays the buttons to upload, download, share, and unshare files
     */
    ...
    /**
     * Shows the page to download a file
     * @param primaryStage
     */
    ...
    /**
     * Handle the login, sends the username and password to the server to verify in the database
     * @param username
     * @param password
     */
    ...
    /**
     * Sends a registration request to the server and handles the responses to the server
     * @param username
     * @param password
     */
    ...
    /**
     * Opens a file chooser to choose a file to send to the server.
     * @param primaryStage
     */
    ...
    /**
     * Chooses a directory to store a file in and sends a download request to the server to download a file
     * @param primaryStage
     * @param fileName
     */
    ...
    /**
     * sends a share request to the server to share a file with a specific user
     * @param primaryStage
     * @param fileName
     * @param shareUser
     */
    ...
    /**
     * Sends an unshare request to the server to unshare a file with a user
     * @param primaryStage
     * @param selection
     */
    ...
    /**
     * Get all the files that a user has access to by sending a request to the server
    ...
    /**
     * Get all the files owned by a logged in user from the server
     * @return - An array list of owned files
     */
    ...
    /**
     * Get all the files shared to the currently logged in user from the server
     * @return - List of all files shared with a user
     */
